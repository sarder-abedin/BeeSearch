...
def _llm(model_name: str, num_ctx: int) -> ChatOllama:
    ...
    return ChatOllama(model=model_name or cfg.ollama_model, base_url=cfg.ollama_base_url, temperature=0.3, num_predict=1024, num_ctx=num_ctx or cfg.num_ctx, sync_client_kwargs={"timeout": httpx.Timeout(300.0)}, callbacks=get_langfuse_callbacks())
