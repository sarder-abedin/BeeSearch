"""
app.py — Streamlit entry point for ResearchBuddy
─────────────────────────────────────────────────
Two research modes: Systematic Review and Research Notebook.
...
_PROJECT_MODULES = {
    "systematic_review": "projects.mode1_systematic_review",
    "notebook": "projects.mode2_notebook",
}
...
def main() -> None:
    ...
    if active_project:
        ...
        if not module_path:
            st.error(f"Unknown mode: {active_project}")
            return
